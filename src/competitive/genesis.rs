...
struct RivalTemplate {
  ...
  emergency_capacity: i32,
  icu_capacity: i32,
  obstetrics_capacity: i32,
  psychiatric_capacity: i32,
  cardiology_capacity: i32,
  oncology_capacity: i32,
  infusion_capacity: i32,
  neurology_capacity: i32,
  asc_capacity: i32,
  nurses: i32,
  physicians: i32,
  admins: i32,
...
const RIVERSIDE: RivalTemplate = RivalTemplate {
  ...
  icu_capacity: 0,
  obstetrics_capacity: 0,
  psychiatric_capacity: 0,
  cardiology_capacity: 0,
  oncology_capacity: 0,
  infusion_capacity: 0,
  neurology_capacity: 0,
  asc_capacity: 0,
  nurses: 24,
  physicians: 10,
  admins: 11,
...
fn system_from_template(
  ...
  HealthSystemState {
    ...
    emergency_capacity: template.emergency_capacity,
    icu_capacity: template.icu_capacity,
    obstetrics_capacity: template.obstetrics_capacity,
    psychiatric_capacity: template.psychiatric_capacity,
    cardiology_capacity: template.cardiology_capacity,
    oncology_capacity: template.oncology_capacity,
    infusion_capacity: template.infusion_capacity,
    neurology_capacity: template.neurology_capacity,
    asc_capacity: template.asc_capacity,
...
pub fn genesis_roster_lines(world: &CompetitiveWorldState) -> Vec<String> {
  world
    ...
    .filter_map(|slot| {
      ...
      Some(format!(
        "  {} — {} beds, {} clinics, {} ICU beds, {} Obstetrics beds, {} Psychiatric beds, {} Cardiology beds, {} emergency bays, access {}, share index {} ({})",
        system.name,
        system.staffed_beds,
