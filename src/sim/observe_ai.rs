...
fn observation_from_system(
  ...
  AiPlayerObservation {
    ...
    psychiatric_capacity: system.psychiatric_capacity,
    cardiology_capacity: system.cardiology_capacity,
    oncology_capacity: system.oncology_capacity,
    infusion_capacity: system.infusion_capacity,
    neurology_capacity: system.neurology_capacity,
    asc_capacity: system.asc_capacity,
