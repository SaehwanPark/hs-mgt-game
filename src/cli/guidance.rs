...
pub fn context_help_lines(context: PromptContext) -> Vec<String> {
  ...
  match context {
    ...
    PromptContext::CompetitiveCommand => {
      ...
      lines.push("    invest domain=beds|outpatient|technology|emergency|icu amount=<int>: Expand capacity. Costs 1 AP, cash amount. Beds, outpatient services, technology, emergency, or ICU investments.".to_string());
    ...
    "invest" => Some(vec![
      ...
      style::label_value(
        ...
        &format!(
          "{} {}",
          style::accent("invest"),
          style::dim("domain=beds|outpatient|technology|emergency|icu amount=<int>")
        ),
      ),
    ...
    "project" => Some(vec![
      ...
      style::label_value(
        ...
        &format!(
          ...
          style::dim(
            "kind=ehr_epic|ehr_cerner|tower|clinic_network|emergency_pavilion|icu_wing budget=<int>"
          )
        ),
      ),
      style::label_value(
