...
pub struct ScenarioSystemState {
  ...
  pub obstetrics_capacity: Option<i32>,
  pub psychiatric_capacity: Option<i32>,
  pub cardiology_capacity: Option<i32>,
  pub oncology_capacity: Option<i32>,
  pub infusion_capacity: Option<i32>,
  pub neurology_capacity: Option<i32>,
  pub asc_capacity: Option<i32>,
  pub nurses: i32,
  pub physicians: i32,
  pub admins: i32,
  ...
  pub fn initial_competitive_world_state(
    ...
    for sys in systems_spec {
      ...
      systems.push(HealthSystemState {
        ...
        obstetrics_capacity: sys.obstetrics_capacity.unwrap_or(0),
        psychiatric_capacity: sys.psychiatric_capacity.unwrap_or(0),
        cardiology_capacity: sys.cardiology_capacity.unwrap_or(0),
        oncology_capacity: sys.oncology_capacity.unwrap_or(0),
        infusion_capacity: sys.infusion_capacity.unwrap_or(0),
        neurology_capacity: sys.neurology_capacity.unwrap_or(0),
        asc_capacity: sys.asc_capacity.unwrap_or(0),
        nurses: sys.nurses,
