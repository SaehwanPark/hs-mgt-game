...
No third-party release assets are included in v0.12.73. Runtime-generated
...
| --- | --- | --- | --- | --- | --- |
| Audio | `audio.direction-prototype` | `gui/audio-direction.mjs` | project-generated | Generated in this repository; no third-party asset. | approved |
| Audio | `audio.runtime-ambience-library` | `gui/ambience-contract.mjs` | project-generated | Generated in this repository; no third-party asset. | approved |
| Audio | `audio.runtime-cue-refinement` | `gui/audio-cue-contract.mjs` | project-generated | Generated in this repository; no third-party asset. | approved |
| Audio | `audio.runtime-event-cues` | `gui/audio.mjs` | project-generated | Generated in this repository; no third-party asset. | approved |
| Audio | `audio.runtime-music` | `gui/audio.mjs` | project-generated | Generated in this repository; no third-party asset. | approved |
| Audio | `audio.runtime-music-stems` | `gui/music-stem-contract.mjs` | project-generated | Generated in this repository; no third-party asset. | approved |
| Audio | `audio.runtime-ui-cues` | `gui/audio.mjs` | project-generated | Generated in this repository; no third-party asset. | approved |
| Visual | `visual.actor-family-language` | `gui/actor-families.mjs` | project-generated | Generated in this repository; no third-party asset. | approved |
...
| Visual | `visual.facility.patient-tower` | `assets/source/visual/facilities/patient-tower.svg` | project-generated | Hand-authored in this repository; fictional facility component with no third-party asset. | approved |
| Visual | `visual.facility.research-education-building` | `assets/source/visual/facilities/research-education-building.svg` | project-generated | Hand-authored in this repository; fictional facility component with no third-party asset. | approved |
| Visual | `visual.facility.rural-clinic` | `assets/source/visual/facilities/rural-clinic.svg` | project-generated | Hand-authored in this repository; fictional facility component with no third-party asset. | approved |
| Visual | `visual.facility.specialty-center` | `assets/source/visual/facilities/specialty-center.svg` | project-generated | Hand-authored in this repository; fictional facility component with no third-party asset. | approved |
| Visual | `visual.facility.undeveloped-parcel` | `assets/source/visual/facilities/undeveloped-parcel.svg` | project-generated | Hand-authored in this repository; fictional facility component with no third-party asset. | approved |
| Visual | `visual.facility.utility-plant` | `assets/source/visual/facilities/utility-plant.svg` | project-generated | Hand-authored in this repository; fictional facility component with no third-party asset. | approved |
...
| Visual | `visual.map.event-marker-set` | `gui/map-event-markers.mjs` | project-generated | Generated in this repository; no third-party asset. | approved |
...
| Visual | `visual.map.relationship-line-styles` | `gui/map-relationships.mjs` | project-generated | Generated in this repository; no third-party asset. | approved |
...
| Visual | `visual.map.service-area-overlays` | `gui/map-service-areas.mjs` | project-generated | Generated in this repository; no third-party asset. | approved |
...
| Visual | `visual.runtime-consequence-links` | `gui/consequence-links.mjs` | project-generated | Generated in this repository; no third-party asset. | approved |
...
| Visual | `visual.runtime-metric-visualizations` | `gui/metric-visualizations.mjs` | project-generated | Generated in this repository; no third-party asset. | approved |
| Visual | `visual.runtime-motion-catalog` | `gui/motion-catalog.mjs` | project-generated | Generated in this repository; no third-party asset. | approved |
...
| Visual | `visual.runtime-regional-board-adapter` | `gui/regional-board.mjs` | project-generated | Generated in this repository; no third-party asset. | approved |
| Visual | `visual.runtime-resolution-sequence` | `gui/resolution-sequence.mjs` | project-generated | Generated in this repository; no third-party asset. | approved |
| Visual | `visual.runtime-semantic-containers` | `gui/semantic-containers.mjs` | project-generated | Generated in this repository; no third-party asset. | approved |
