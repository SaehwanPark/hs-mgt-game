# Implementation Plan — Phase 3.1 construction-crane v0.12.53

## Objective

Extend the reusable facility layer contract to a distinct fictional
construction crane without creating a second rendering path or a project-status
claim.

## Scope

- Add construction-crane source/release SVG derivatives using the shared 8px
...
- Construction crane is visually distinct from existing components while using
