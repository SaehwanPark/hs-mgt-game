...
The current public milestone is a playable Rust prototype at v0.13.0. Its
...
catalog-level missing-asset fallback coverage and v0.13.0 defines the current
raster release/preview boundary without claiming runtime performance; full
campaign continuity remains open.
