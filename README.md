...
The current public milestone is a playable Rust prototype at v0.12.93. Its
...
resolution contexts while preserving visible-only legacy classification; full
campaign save/load/replay continuity remains open.
