...
The current public milestone is a playable Rust prototype at v0.12.57. Its
...
road tile set; v0.12.57 adds a fixture-only symbolic district tile set; later
map modules remain bounded future slices.
It is
