...
const EVENT_FIELDS = Object.freeze({
  ...
  audio_queue_bounded: ["id", "priority", "overflow_count"],
  audio_batch_planned: ["request_count", "duplicate_count", "routine_aggregated_count", "overflow_count"],
  audio_playback_failed: ["id", "message"],
