...
This is a dependency-free Phase 2/3 browser surface over typed actor-visible
MCP presentation and action contracts. Open `index.html` through a static file
server and provide a live or recorded read-only adapter:
...
For Phase 3 action submission, inject a separate host adapter with
...
assets, replay playback, and campaign expansion remain later phases.
