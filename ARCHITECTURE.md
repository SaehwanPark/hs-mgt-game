...
comparison of same-genesis committed stabilization histories. It reports
aligned state and effect deltas plus resolved-input parity without recalculating
runs or claiming causal certainty. It does not create a browser instructor
route, distributional view, export format, or new authority boundary.
