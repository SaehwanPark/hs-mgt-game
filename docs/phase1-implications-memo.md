...
[`evidence-registry.md`](evidence-registry.md), [`_workspace/01_evidence_map.md`](../_workspace/01_evidence_map.md))
...
| Actor cards before runtime actor expansion | Mechanism design control | [`actor-cards.md`](actor-cards.md) |
| Parameter ledger before calibration | Phase 1 evidence spine recommendation | [`evidence-registry.md`](evidence-registry.md) §Parameter-Source Ledger |
...
- **Next work:** See [`actor-cards.md`](actor-cards.md) competitor card and
...
| Mechanism register | [`evidence-registry.md`](evidence-registry.md) mechanism table |
...
- [`evidence-registry.md`](evidence-registry.md) — mechanism and parameter ledger
- [`phase5-scope-register.md`](phase5-scope-register.md) — Phase 5 closure and next slice
- [`first-scenario-brief.md`](first-scenario-brief.md) — scenario expansion gates
