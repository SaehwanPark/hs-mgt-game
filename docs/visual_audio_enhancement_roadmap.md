...
**Status:** Partial in v0.12.46; general hospital base, patient tower, emergency department, and ambulatory center components complete
...
`tests/test_ambulatory_center.py`.
