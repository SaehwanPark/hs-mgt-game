...
**Status:** Partial in v0.12.47; general hospital base, patient tower, emergency department, ambulatory center, and specialty center components complete
...
`tests/test_ambulatory_center.py` plus `tests/test_specialty_center.py`.
