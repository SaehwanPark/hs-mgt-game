...
- **Evidence inputs:**
  - `docs/history/playtests/v0.9/playtest-findings-v0.9.8.md`
  - `docs/history/playtests/v0.9/playtest-findings-v0.9.9.md`
  ...
  - `docs/history/playtests/v0.10/playtest-findings-v0.10.35.md`
  - `docs/design/expansion-proposal-review.md`
- **Exemplar artifacts:**
