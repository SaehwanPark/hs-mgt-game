...
| --- | --- | ---: | --- | --- | ---: |
| `docs/history/playtests/v0.10/playtest-findings-v0.10.0.md` | Can three free-form Hard profiles complete seed 42? | 3 | 42 | baseline | 0 |
| `docs/history/playtests/v0.10/playtest-findings-v0.10.1.md` | Do the same profiles complete seeds 42-44? | 9 | 42, 43, 44 | baseline | 0 |
| `docs/history/playtests/v0.10/playtest-findings-v0.10.2.md` | Can bounded operator variants reduce access-pledge loops? | 27 | 42, 43, 44 | baseline, cooldown, threshold | 0 |
| `docs/history/playtests/v0.10/playtest-findings-v0.10.4.md` | Can post-guidance behavior be represented by a bounded policy? | 18 | 42, 43, 44 | baseline, guidance-aware | 0 |
