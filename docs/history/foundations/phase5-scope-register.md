...
| --- | --- |
| Comprehensibility | [`playtest-findings-v0.1.25.md`](../playtests/v0.1/playtest-findings-v0.1.25.md) |
...
| One short scenario | Complete (design) | [`first-scenario-brief.md`](../../design/first-scenario-brief.md) |
...
| Internal playtest findings | Complete | [`playtest-findings-v0.1.25.md`](../playtests/v0.1/playtest-findings-v0.1.25.md) |
...
| Employer or patient-group strategy | Deferred | Per [`first-scenario-brief.md`](../../design/first-scenario-brief.md) excluded interactions |
| Federal legislative process | Deferred | Per [`system-boundary.md`](../../design/system-boundary.md) excluded processes |
...
| Empirical calibration | Prototype integers remain design abstractions per [`evidence-registry.md`](../../research/evidence-registry.md) |
...
| Item | Rationale |
| --- | --- |
| AI-agent playtest synthesis | Phase 7 scope; active path per the [playtesting protocol](../../validation/playtesting.md) |
...
[`gameplay-competitive-sketch.md`](../../design/gameplay-competitive-sketch.md), roadmap
...
| --- | --- | --- |
| False precision | Medium | Label prototype formulas as abstractions in [`system-boundary.md`](../../design/system-boundary.md) and [`evidence-registry.md`](../../research/evidence-registry.md); defer calibration until parameter ledger exists |
| Scope drift | Medium | Use this register and [`first-scenario-brief.md`](../../design/first-scenario-brief.md) readiness checklist before runtime expansion; actor cards required before new strategic actors |
...
| Documentation staleness | Medium | Version playtest findings with releases; keep SPEC Present/Done accurate; full slice history in [`spec-past-archive.md`](../archives/spec-past-archive.md) |
...
- [`first-scenario-brief.md`](../../design/first-scenario-brief.md) — scenario concept and expansion gates
- [`system-boundary.md`](../../design/system-boundary.md) — actor and command boundaries
- [`playtest-findings-v0.1.25.md`](../playtests/v0.1/playtest-findings-v0.1.25.md) — internal playtest record
- [`evidence-registry.md`](../../research/evidence-registry.md) — mechanism evidence status
