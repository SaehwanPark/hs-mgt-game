...
- Feature: Evidence, parameters, and model-confidence ledger
  ...
  Done:
  - Create a detailed parameter/evidence ledger at `docs/research/workforce-ledger.md` mapping workforce-related parameters and formulas to literature citations (BLS, California AB 394 safe staffing, Aiken JAMA 2002 nurse burnout).
  ...
  - Update `docs/research/evidence-registry.md` to reference and link `docs/research/workforce-ledger.md`.
...
- Feature: Exemplary scenario brief
  ...
  Summary:
  Draft the first exemplary scenario brief for the competitive regional campaign (`docs/design/exemplary-scenario-brief.md`), modeling workforce conflicts, certificate of need legal challenges, Blue Shield payer negotiations, and delayed EHR consequences, accompanied by workspace handoff documents.
...
- Feature: Public playable prototype announcement prep
  ...
  - Replace `README.md` with a player/portfolio-oriented overview covering the
    ...
    checks.
  - Archive the previous README at `docs/history/archives/README-dev-archive-v0.1.61.md`.
...
- Feature: Coalition cooperative interaction slice
  ...
  - Add `docs/design/system-boundary.md` and `docs/research/evidence-registry.md` stubs
  - Update architecture, changelog, lessons, and handoff files
...
- Feature: Phase 2 system boundary and ontology slice
  ...
  - Coalition cooperative interaction slice moved from active state into
    completed history
  - `docs/design/system-boundary.md` expanded from a stub into a Phase 2 conceptual
    boundary draft
  - `docs/research/evidence-registry.md` updated to align current mechanisms with the
...
- Feature: Phase 3 actor cards and first scenario brief
  ...
  Done:
  - Working branch created from `main`
  - `docs/design/actor-cards.md` added with required actor design fields for future
    strategic actors
  - `docs/design/first-scenario-brief.md` added with the first scenario concept,
    learning objectives, included interactions, strategic tensions, observation
    use, debrief hooks, and non-goals
  - `docs/design/system-boundary.md` and `docs/research/evidence-registry.md` updated to point
...
- Feature: Replay artifact export and playtest findings slice
  ...
  - Added `docs/history/playtests/v0.1/playtest-findings-v0.1.15.md`
  - Updated architecture, changelog, lessons, and workspace handoff artifacts
...
- Feature: Phase 5 scope and risk register
  ...
  Done:
  - Working branch created from `main`
  - `docs/history/foundations/phase5-scope-register.md` added with achieved, deferred, risk, and
    exit-criteria assessment
  - `docs/history/playtests/v0.1/playtest-findings-v0.1.19.md` added for post-refactor and CI state
...
- Feature: Phase 1 research-to-design implications memo
  ...
  - Added `docs/history/foundations/phase1-implications-memo.md`
  - Expanded `docs/research/evidence-registry.md` with parameter-source ledger
...
- Feature: Phase 0 governance docs
  ...
  Done:
  - Added `docs/reference/glossary.md`
  - Added `docs/decision-records/README.md` and `0000-template.md`
  - Added `docs/reference/versioning-policy.md`
...
- Feature: SPEC reconciliation and Phase 5 register refresh
  ...
  Done:
  - Working branch created from `main`
  - `docs/history/foundations/phase5-scope-register.md` refreshed for five-turn closure and
    competitor achieved
  - `docs/design/system-boundary.md` updated with `RespondToCompetitorCapacityMove` and
    rival capacity inclusion
  - `docs/research/evidence-registry.md` updated for five-turn wording and competitor
    ledger `linked` status
  - `docs/history/playtests/v0.1/playtest-findings-v0.1.21.md` next-slice note marked superseded
...
- Feature: First architecture decision record and scenario format draft
  ...
  - Added `docs/design/scenario-format-draft.md`
...
- Feature: Forecast and uncertainty CLI preview
  ...
  - Added `docs/history/playtests/v0.1/playtest-findings-v0.1.25.md`
...
- Feature: Competitive gameplay design package
  ...
  - `docs/design/gameplay-competitive-sketch.md` with acceptance criteria per sketch bullet
  - `docs/design/core-loop-spec.md` (Phase 3 deliverable) for both campaigns
...
- Feature: New-player How to Play manual
  ...
  Done:
  - `docs/guides/how-to-play.md` added with quickstart, campaign flow, terminology,
...
- Feature: External playtest protocol refresh
  ...
  Done:
  - `docs/validation/playtesting.md` added with setup, session scripts,
...
- Feature: MCP agent support
  ...
  - ADR-0008 and `docs/reference/mcp-agent-interface.md`
...
- Feature: Automated MCP playtest findings
  ...
  Done:
  - `docs/history/playtests/v0.1/playtest-findings-v0.1.42.md` summarizes three strategy runs across
...
- Feature: Playtest-guided player guidance
  ...
  - Competitive observation and MCP debrief text explain that recruitment spends
    ...
    workforce trust
  - `docs/guides/how-to-play.md` records the same player-facing strategy notes
...
- Feature: Deferred item triage
  ...
  Verification:
  - Deferred-item scan reviewed `SPEC.md` and `docs/history/archives/spec-past-archive.md`
...
- Feature: AI-agent playtest validation pivot
  ...
  Done:
  - Added `docs/validation/playtesting.md` with required MCP evidence,
...
- Feature: AI-agent playtest evidence
  ...
  - MCP Python client now launches the built stdio server by default, uses
    ...
    of looping silently
  - `docs/history/playtests/v0.1/playtest-findings-v0.1.49.md` records six completed seed-42 sessions,
...
- Feature: Seed-variation playtest evidence
  ...
  - `docs/history/playtests/v0.1/playtest-findings-v0.1.51.md` records 18 completed scripted MCP
...
- Feature: Naive-profile playtest evidence
  ...
  - `docs/history/playtests/v0.1/playtest-findings-v0.1.52.md` records 24 completed scripted MCP
...
- Feature: Free-form agent playtest evidence
  ...
  Done:
  - `docs/history/playtests/v0.1/playtest-findings-v0.1.54.md` records one stabilization and one
  ...
  - `docs/guides/mcp-playtesting-guide.md` documents the operator-run free-form
    evidence procedure
...
- Feature: Free-form profile synthesis
  ...
  Done:
  - `docs/history/playtests/v0.1/playtest-findings-v0.1.55.md` records two stabilization and two
