...
Archived copy of the developer-focused README that was replaced by the public
project README in v0.2.0. Links have been adjusted for this file's location
inside `docs/`.
...
See [`docs/design/core-loop-spec.md`](../../design/core-loop-spec.md),
...
Canonical project documents are maintained in this directory:

- [Project Proposal](../../proposal.md)
- [Development Roadmap](../../roadmap.md)
- [Design Principles](../../design_principles.md)
- [How To Play (New Players)](../../guides/how-to-play.md)
- [Actor Card Template](../../design/actor-cards.md)
- [First Scenario Brief](../../design/first-scenario-brief.md)
- [Phase 1 Implications Memo](../foundations/phase1-implications-memo.md)
- [Glossary](../../reference/glossary.md)
- [Versioning Policy](../../reference/versioning-policy.md)
- [Architecture Decision Records](../../decision-records/README.md)
- [ADR 0001: Deterministic transition boundary](../../decision-records/0001-deterministic-transition-and-stochastic-input-boundary.md)
- [ADR 0002: Mid-run session save](../../decision-records/0002-mid-run-session-save.md)
- [Scenario Format Draft](../../design/scenario-format-draft.md)
- [Phase 5 Scope Register](../foundations/phase5-scope-register.md)
- [Internal Playtest Findings (v0.1.25)](../playtests/v0.1/playtest-findings-v0.1.25.md)
- [AI-Agent Playtest Findings (v0.1.49)](../playtests/v0.1/playtest-findings-v0.1.49.md)
- [AI-Agent Seed-Variation Findings (v0.1.51)](../playtests/v0.1/playtest-findings-v0.1.51.md)
- [AI-Agent Naive-Profile Findings (v0.1.52)](../playtests/v0.1/playtest-findings-v0.1.52.md)
- [AI-Agent Free-Form Findings (v0.1.54)](../playtests/v0.1/playtest-findings-v0.1.54.md)
- [AI-Agent Free-Form Synthesis (v0.1.55)](../playtests/v0.1/playtest-findings-v0.1.55.md)
- [AI-Agent Strategy-Space Diagnostics (v0.1.56)](../playtests/v0.1/playtest-findings-v0.1.56.md)
- [AI-Agent Playtest Protocol](../../validation/playtesting.md)
- [External Playtest Protocol (Superseded)](../../validation/playtesting.md)
- [MCP Agent Interface](../../reference/mcp-agent-interface.md)
...
in this directory, including the [glossary](../../reference/glossary.md),
[versioning policy](../../reference/versioning-policy.md), and
[decision-record template](../../decision-records/0000-template.md).
