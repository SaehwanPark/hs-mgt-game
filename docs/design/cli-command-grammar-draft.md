...
**Status:** Maintained CLI reference; reviewed for v0.14.2
...
- Tab autocomplete for verbs, argument keys, and enum values
...
| `?` | Alias for `help` |
| `quit` / `q` | Exit command path; autosave/resume uses ADR-0002-derived save semantics |
