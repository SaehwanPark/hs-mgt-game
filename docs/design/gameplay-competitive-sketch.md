...
- Six-section report schema in `docs/design/executive-report-format.md`
...
- No global equilibrium solver ([`phase1-implications-memo.md`](../history/foundations/phase1-implications-memo.md))
...
- Verb + typed arguments per `docs/design/action-catalog-draft.md`
...
- [x] `docs/design/cli-command-grammar-draft.md` complete
