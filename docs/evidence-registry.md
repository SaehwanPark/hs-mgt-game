...
| Regional merger/acquisition | v0.11.13 affiliation-first design gate; future Phase 7/9 runtime proposal | Literature-grounded direction / stylized abstraction | DOJ/FTC merger review and HHS consolidation materials support institutional relevance; design outcomes must not imply legal forecasting or calibrated mechanics |
