...
See [`docs/core-loop-spec.md`](core-loop-spec.md),
...
- [How To Play (New Players)](how-to-play.md)
- [Actor Card Template](actor-cards.md)
- [First Scenario Brief](first-scenario-brief.md)
- [Phase 1 Implications Memo](phase1-implications-memo.md)
...
- [Scenario Format Draft](scenario-format-draft.md)
- [Phase 5 Scope Register](phase5-scope-register.md)
- [Internal Playtest Findings (v0.1.25)](playtest-findings-v0.1.25.md)
- [AI-Agent Playtest Findings (v0.1.49)](playtest-findings-v0.1.49.md)
- [AI-Agent Seed-Variation Findings (v0.1.51)](playtest-findings-v0.1.51.md)
- [AI-Agent Naive-Profile Findings (v0.1.52)](playtest-findings-v0.1.52.md)
- [AI-Agent Free-Form Findings (v0.1.54)](playtest-findings-v0.1.54.md)
- [AI-Agent Free-Form Synthesis (v0.1.55)](playtest-findings-v0.1.55.md)
- [AI-Agent Strategy-Space Diagnostics (v0.1.56)](playtest-findings-v0.1.56.md)
- [AI-Agent Playtest Protocol](agent-playtest-protocol.md)
- [External Playtest Protocol (Superseded)](external-playtest-protocol.md)
...
in this directory, including the [glossary](glossary.md),
[versioning policy](versioning-policy.md), and
