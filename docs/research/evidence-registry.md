...
**Status:** Maintained research reference; mapped against v0.14.3
...
| Competitive regional campaign | Implemented runtime and maintained design reference | Project requirement / gameplay-driven abstraction | 24-month host-authoritative campaign; see [`gameplay-competitive-sketch.md`](../design/gameplay-competitive-sketch.md) and ADRs 0003–0006 |
...
- See [`phase1-implications-memo.md`](../history/foundations/phase1-implications-memo.md) for
  research-to-design implications from Phase 1.
- See [`phase5-scope-register.md`](../history/foundations/phase5-scope-register.md) for Phase 5 closure,
  deferred world elements, and recommended next runtime slice.
- Use [`actor-cards.md`](../design/actor-cards.md) before adding future strategic actors.
- Use [`first-scenario-brief.md`](../design/first-scenario-brief.md) to keep first-slice
