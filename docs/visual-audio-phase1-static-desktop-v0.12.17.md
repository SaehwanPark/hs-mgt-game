...
[`docs/visual_audio_upgrade_proposal.md`](visual_audio_upgrade_proposal.md) and
the Phase 0 boundary in
[`docs/visual-audio-phase0-alignment-v0.12.16.md`](visual-audio-phase0-alignment-v0.12.16.md).
